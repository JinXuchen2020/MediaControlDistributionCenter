...
namespace MediaControlDistributionCenter.Views.CustomControls
{
    ...
    public class PagingModel : INotifyPropertyChanged
    {
        public class PageNumber
        {
            ...
            /// 前往页面
            /// </summary>
            public RelayCommand GotoPage { get; set; }
        ...
        private void GotoPageFun(object obj)
        {
        }
        ...
        /// 页码列表
        /// </summary>
        public List<PageNumber> PageNumberList { get; set; }

        public void SetPageNumberList()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (i == 3)
                {
                    PageNumberList[i].Page = "...";
                    PageNumberList[i].GotoPage = new RelayCommand(GotoPageFun);
                    continue;
                }
                else
                {
