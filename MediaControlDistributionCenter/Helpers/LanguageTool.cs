...
namespace MediaControlDistributionCenter
{
    ...
    public class LanguageTool
    {
        ...
        {
            { Language.Chinese,@"Themes/Language/Chinese.xaml" },
            { Language.English,@"Themes/Language/English.xaml" },
            { Language.Japanese,@"Themes/Language/Japanese.xaml" },
            { Language.Korean,@"Themes/Language/Korean.xaml" }
        };

        /// <summary>
        /// 缓存的资源
        /// </summary>
        public IDictionary<string, string> LanguageResourceCache = new Dictionary<string, string>();
        ...
        /// 根据文本找对应的翻译  
        /// 
        /// 当前文本 到 系统中 找对应的key.找到key后 找指定语音 版本的 key对应的文本 实现翻译
        /// </summary>
